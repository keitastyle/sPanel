...
public class ProfessorDAOImpl implements ProfessorDAO {
    ...
    private static final String SQL_INSERT =
            "INSERT INTO professors(department_id,grade) VALUES(?,?)";
    private static final String SQL_SELECT_BY_ID =
            "SELECT id, department_id, grade FROM professors WHERE id=?";
    private static final String SQL_SELECT_BY_NAME =
            "SELECT professors.id, professors.department_id, professors.grade FROM professors, users WHERE CONCAT(first_name, ' ', last_name) =  ?";
    private static final String SQL_SELECT_ALL =
            "SELECT id, department_id, grade FROM professors";
    private static final String SQL_SELECT_MODULE_RESPONSABLE_BY_IDS =
            "SELECT * FROM professors WHERE id =" +
                    "(SELECT responsable_id FROM class_module WHERE class_id = ? AND module_id = ?)";
    ...
    @Override
    public Professor findResponsable(Long classId, Long moduleId) throws DAOException {
        return find(SQL_SELECT_MODULE_RESPONSABLE_BY_IDS, classId, moduleId);
    }
