...
public  class AffectationDAOImpl implements AffectationDAO {
    ...
    private static final String SQL_SELECT_BY_ID =
            "SELECT affectations.id,professor_id,class_id, module_id,course_id,hours,coefficient " +
                    ...
                    "WHERE class_module_id = class_module.id AND affectations.id = ?";
    ...
    private static final String SQL_FIND_ALL_BY_CLASS_ID_AND_PROFESSOR_ID =
            "SELECT affectations.id,professor_id,class_id, module_id,course_id,hours,coefficient " +
                    "FROM affectations, class_module " +
                    "WHERE class_module_id = class_module.id AND class_module.class_id = ? AND professor_id = ?";

    private static final String SQL_FIND_ALL_BY_CLASS_ID_AND_PROFESSOR_ID_AND_COURSE_ID =
            "SELECT affectations.id,professor_id,class_id, module_id,course_id,hours,coefficient " +
                    "FROM affectations, class_module " +
                    "WHERE class_module_id = class_module.id AND class_module.class_id = ? AND professor_id = ? AND course_id = ?";
    ...
    @Override
    public Affectation find(Long id) throws DAOException {
        return find(SQL_SELECT_BY_ID, id);
    }

    @Override
    public Affectation find(Professor professor, Class classroom, Course course) throws DAOException {
        return null;
    }

    @Override
    public Affectation find(Long professorId, Long classId, Long courseId) throws DAOException {
        return find(SQL_FIND_ALL_BY_CLASS_ID_AND_PROFESSOR_ID_AND_COURSE_ID, classId, professorId, courseId);
    }
    ...
    @Override
    public List<Affectation> findAll(Professor professor, Class classroom) throws DAOException {
        return findMany(SQL_FIND_ALL_BY_CLASS_ID_AND_PROFESSOR_ID, classroom.getId(), professor.getId());
    }
