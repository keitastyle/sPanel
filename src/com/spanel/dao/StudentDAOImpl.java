...
public class StudentDAOImpl implements StudentDAO {
    ...
    private static final String SQL_UPDATE = "UPDATE students SET class_id = ? WHERE id = ?";
    ...
    public void update(Student student) throws DAOException {
        ...
        try{
            connection = daoFactory.getConnection();
            preparedStatement = initPreparedStatement(connection,SQL_UPDATE,true,student.getClassId(),student.getId());
            int state = preparedStatement.executeUpdate();
            if ( state == 0 ) {
                throw new DAOException("Failed to update student,No rows have been modified to the table ");
            }
        } catch ( SQLException e ) {
            throw new DAOException( e );
        } finally {
    ...
    @Override
    public Student findByStudentId(Long studentId) throws DAOException {
