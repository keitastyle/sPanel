...
public class ClassDAOImpl implements ClassDAO {
    ...
    private static final String SQL_FIND_PROFESSOR_CLASSES = "SELECT DISTINCT classes.id, classes.name, classes.department_id FROM classes, affectations WHERE affectations.professor_id = ? AND affectations.class_module_id IN (SELECT id FROM class_module WHERE class_id = classes.id)";

    private static final String SQL_ALLOCATE_MODULE = "INSERT INTO class_module(class_id, module_id, responsable_id) VALUES (?,?,?)";
    ...
    private Class find (String sql, Object... objects ) throws DAOException{
